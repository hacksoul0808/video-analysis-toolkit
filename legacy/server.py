...
def download_video(url, output_dir, video_id):
    ...
    vdl_path = BASE_DIR / "scripts" / "vdl.py"
...
class APIHandler(SimpleHTTPRequestHandler):
    ...
    def _serve_html(self):
        ...
        if not html_path.exists():
            self._send_json({"error": "web/index.html not found. Please create the frontend file."}, 500)
            return
    ...
    def _handle_sound(self, path):
        """Serve .mp3 sound files from web/assets/sounds/ directory."""
